...
| POST   | <int:product_id>/reviews/add/                   | Post a review for a product.                                   |
| PUT    | <int:product_id>/reviews/<int:pk>/update/       | Update a specific review.                                      |
| DELETE |<int:product_id>/reviews/<int:pk>/delete/        | Delete a specific review.                                      |
|--------|-------------------------------------------------|----------------------------------------------------------------|
